...
public class MainActivity extends Activity {
    ...
    Integer numBtnIDs[] = {R.id.btn1, R.id.btn2, R.id.btn3, R.id.btn4, R.id.btn5, R.id.btn6, R.id.btn7, R.id.btn8, R.id.btn9,
            R.id.btn0};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        texw1 = (TextView) findViewById(R.id.Texw1);
        ...
        add.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                texw1.setText("계산결과:" + result.toString());
                return false;
            }
        });
            ...
            numBtn[index].setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    if (edit1.isFocused() == true) {
                        ...
                        Toast.makeText(getApplicationContext(), "먼저 에디트텍스트를 선택하세요.", 0).show();
                    }
                }
            });
        }
